...
ZC2ZCmainZCMainZC: ($1) => (document.getElementById('lastKey').textContent = String($1)),
ZC3ZCmainZCMainZC: ($1) => (document.getElementById('tickCount').textContent = String($1)),
ZC4ZCmainZCMainZC: ($1) => (document.addEventListener('keydown', $1)),
ZC6ZCmainZCMainZC: ($1) => ((...args) => __exports.ghczuwasmzujsffiZC5ZCmainZCMainZC($1, ...args)),
ZC7ZCmainZCMainZC: ($1) => ($1.keyCode),
